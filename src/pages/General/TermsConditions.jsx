          ...
          <div className="max-w-6xl mx-auto">
            <div className={`rounded-xl md:rounded-2xl border p-4 md:p-6 lg:p-8 mb-6 md:mb-8 ${
              ...
              <div className="mb-6 md:mb-8">
                ...
                <p className={`text-xs md:text-sm leading-relaxed mt-2 md:mt-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <div className="mb-6 md:mb-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div>
                    ...
                    <h3 className={`font-medium mb-2 md:mb-3 mt-3 md:mt-4 text-sm md:text-base ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                      Refunds
                    </h3>
                    <ul className={`space-y-1 md:space-y-2 text-xs md:text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <div className="mb-6 md:mb-8">
                ...
                <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-start gap-2 md:gap-3">
                    <div className="bg-orange-100 p-1 rounded-full mt-1 flex-shrink-0">
              ...
              <div className="mb-6 md:mb-8">
                <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                  <div className="bg-indigo-100 p-1 md:p-2 rounded-lg">
                ...
                <p className={`text-xs md:text-sm leading-relaxed mb-2 md:mb-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-4 md:p-6 text-white">
                <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                  ...
                  <h3 className="text-base md:text-lg font-semibold">Questions About These Terms?</h3>
                </div>
                <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6 text-xs md:text-sm">
                  <div className="flex items-center gap-1 md:gap-2">
                    <MessageCircle className="w-3 h-3 md:w-4 md:h-4" />
                    <span>support@gurushikri.com</span>
                  </div>
                  <div className="flex items-center gap-1 md:gap-2">
                    <Phone className="w-3 h-3 md:w-4 md:h-4" />
                    <span>+91 (910) 456-7890</span>
                  </div>
                </div>
              </div>
            </div>
